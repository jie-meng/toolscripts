...
def startRegistry():
    ...
    os.system('docker run -d 5000:5000 -v {0}:/var/lib/registry -v {1}:/etc/docker/registry/config.yml --restart-always -name registry registry:2'.format(mappingPath, configPath))
