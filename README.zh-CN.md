...
| 系统       | `dotnet-globaljson`、`toolscripts-list`、`myip`、`checkspace`、`lsdevcu`、`rm-ds-store`、`rm-meta`、`dirdiff`、`intellij`、`pycharm`、`xcode`、`venv-create`、`uvcmd`、`graphifycmd`、`iterm-setup`、`kill-pwchrome` |
