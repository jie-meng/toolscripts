...
| ai         | `ocdo`, `ocdo-models`, `cbdo`, `free-models-openrouter`, `free-models-nvidia`, `agents-setup`, `agents-cleanup`, `ai-links`, `graphifycmd`, `npm-tools`, `llamacmd`, `pi-extensions-setup` |
